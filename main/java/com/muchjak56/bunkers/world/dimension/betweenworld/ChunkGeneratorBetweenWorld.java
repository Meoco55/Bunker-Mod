...
public class ChunkGeneratorBetweenWorld implements IChunkGenerator
{
    ...
    public ChunkGeneratorBetweenWorld(World world, boolean mapFeaturesEnabled, long seed)
    {
        this.world = world;
    ...
    public static float getIslandHeightValue(int x, int z, int p_185960_3_, int p_185960_4_)
    {
        ...
        for (int i = -12; i <= 12; ++i)
        {
            for (int j = -12; j <= 12; ++j)
            {
                ...
                if (k * k + l * l > 4096L && ChunkGeneratorBetweenWorld.islandNoise.getValue((double)k, (double)l) < -0.8999999761581421D)
                {
