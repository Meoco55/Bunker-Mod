...
import com.muchjak56.bunkers.blocks.machine.hyposmelter.HypoSmelterRecipes;
...
public class TileEntityHypoSmelter extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.hypo_smelter";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockHypoSmelter.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = HypoSmelterRecipes.getInstance().getHypoResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = HypoSmelterRecipes.getInstance().getHypoResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
