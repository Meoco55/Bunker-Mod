...
public class JumpPadAngleT3 extends BlockBase
{
	//sets face toward player
		public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public JumpPadAngleT3(String name, Material material) {
		super(name, material);
	 ...
	 protected SoundEvent getSound()
	    {
		 ...
		 public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
		 {
			 ...
			 {
	            case 2: entityIn.motionZ = -7.0D; entityIn.motionY = 1.0D;
	                break; 

	            case 3: entityIn.motionZ = 7.0D; entityIn.motionY = 1.0D;
	                break; 

	            case 4: entityIn.motionX = -7.0D; entityIn.motionY = 1.0D;
	               break;

	            case 5: entityIn.motionX = 7.0D; entityIn.motionY = 1.0D;
	            default: 
	                break;
	        }
			 return;
