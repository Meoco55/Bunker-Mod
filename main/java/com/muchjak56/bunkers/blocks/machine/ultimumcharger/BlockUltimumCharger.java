...
public class BlockUltimumCharger extends BlockBase implements ITileEntityProvider 
{
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) 
	{
		...
		if(active) worldIn.setBlockState(pos, ModBlocks.ULTIMUM_CHARGER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3);
		else worldIn.setBlockState(pos, ModBlocks.ULTIMUM_CHARGER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
	...
	{
		return new TileEntityUltimumCharger();
	}
	...
	{
		TileEntityUltimumCharger tileentity = (TileEntityUltimumCharger)worldIn.getTileEntity(pos);
