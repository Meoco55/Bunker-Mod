...
public class TileEntityUltimumCharger extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.ultimum_charger";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockUltimumCharger.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = UltimumChargerRecipes.getInstance().getUltimumResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = UltimumChargerRecipes.getInstance().getUltimumResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
